...
************************************************************************/
#ifndef COMPRESSIVETRACKER_H
#define COMPRESSIVETRACKER_H
...
private:
	...
	void classifierUpdateHyo(Mat& _sampleFeatureValue, vector<float>& _mu, vector<float>& _sigma, float _learnRate);
...
public:
	...
	void adjustLearnRate();
	void processFrameHyo(Mat& _frame, Rect& _objectBox);
